#############################################################################
# Makefile for building: Silkcoin-Qt.app/Contents/MacOS/Silkcoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Jun 8 23:19:31 2014
# Project:  Silkcoin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake -o Makefile Silkcoin-qt.pro
#############################################################################
...
CC            = /usr/bin/gcc-4.2
CXX           = /usr/bin/g++-4.2
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)   -lqrencode -lminiupnpc /Users/User/silkcoin/src/leveldb/libleveldb.a /Users/User/silkcoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -L/opt/local/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_chrono-mt -lboost_program_options-mt -lboost_thread-mt -framework QtGui -F/opt/local/Library/Frameworks -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		Silkcoin-qt.pro
QMAKE_TARGET  = Silkcoin-Qt
DESTDIR       = 
TARGET        = Silkcoin-Qt.app/Contents/MacOS/Silkcoin-Qt
...
all: Makefile Silkcoin-Qt.app/Contents/PkgInfo Silkcoin-Qt.app/Contents/Resources/empty.lproj Silkcoin-Qt.app/Contents/Info.plist Silkcoin-Qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/User/silkcoin/src/leveldb/libleveldb.a /Users/User/silkcoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_poolbrowser.h build/ui_statisticspage.h build/ui_blockbrowser.h build/ui_optionsdialog.h build/ui_tutoStackDialog.h build/ui_tutoWriteDialog.h build/ui_chatwindow.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Silkcoin-Qt.app/Contents/MacOS/ || $(MKDIR) Silkcoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Silkcoin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile Silkcoin-qt.pro
...
distclean: clean
	-$(DEL_FILE) -r Silkcoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/User/silkcoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/User/silkcoin/src/leveldb && CC=/usr/bin/gcc-4.2 CXX=/usr/bin/g++-4.2 $(MAKE) OPT="-pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/Users/User/silkcoin/build/build.h: FORCE
	cd /Users/User/silkcoin; /bin/sh share/genbuild.sh /Users/User/silkcoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/silkcointask.png \
		src/qt/res/icons/Silkcoin-16.png \
		src/qt/res/icons/statistics.png \
		src/qt/res/icons/Silkcoin-128.png \
