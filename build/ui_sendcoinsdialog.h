...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(815, 458);
        ...
        verticalFrame = new QFrame(SendCoinsDialog);
        verticalFrame->setObjectName(QString::fromUtf8("verticalFrame"));
        verticalFrame->setMinimumSize(QSize(800, 44));
        verticalFrame->setMaximumSize(QSize(800, 44));
        verticalFrame->setStyleSheet(QString::fromUtf8("background:#c7c7c7;"));
        verticalLayout_9 = new QVBoxLayout(verticalFrame);
        ...
        verticalLayout_10->setContentsMargins(52, 10, 22, -1);
        ...
        verticalWidget = new QWidget(frameCoinControl);
        verticalWidget->setObjectName(QString::fromUtf8("verticalWidget"));
        verticalWidget->setMinimumSize(QSize(0, 30));
        verticalLayout_8 = new QVBoxLayout(verticalWidget);
        verticalLayout_8->setObjectName(QString::fromUtf8("verticalLayout_8"));

        verticalLayoutCoinControl->addWidget(verticalWidget);
        ...
        formLayoutCoinControl3->setContentsMargins(6, 4, 0, -1);
        ...
        verticalLayoutCoinControl->setStretch(5, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 741, 85));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 SC", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 SC", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 SC", 0, QApplication::UnicodeUTF8));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0, QApplication::UnicodeUTF8));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 SC", 0, QApplication::UnicodeUTF8));
