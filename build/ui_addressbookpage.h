...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(808, 380);
        ...
        greyFrame->setMinimumSize(QSize(800, 44));
        greyFrame->setMaximumSize(QSize(800, 44));
        greyFrame->setStyleSheet(QString::fromUtf8("background:#c7c7c7;"));
        verticalLayout_9 = new QVBoxLayout(greyFrame);
        verticalLayout_9->setObjectName(QString::fromUtf8("verticalLayout_9"));

        verticalLayout->addWidget(greyFrame);

        verticalLayout_2 = new QVBoxLayout();
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(52, 10, 22, -1);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your Silkcoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a Silkcoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified Silkcoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
